...
<div class="container">
    <div class="card-header" style="background-color: #6ab2ec">
        <table class="table table-borderless justify">
            <tr>
                <th scope="col">
                    <h1 style="font-weight: bold;">UB-02</h1>
                </th>
                <th scope="col" class="d-flex justify-content-end"><a class="btn btn-light" href="{{url('ub02/form')}}" style="color:#000000">Voltar</a></th>
            </tr>
        </table>
    ...
    <div class="card card-body">Sem informações deste equipamento</div>
