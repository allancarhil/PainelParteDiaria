    ...
    <div class="card-header" style="background-color: #6ab2ec">
        <table class="table table-borderless justify">
            <tr>
                ...
                <th scope="col" class="d-flex justify-content-end"><a class="btn btn-light" href="{{url('uc07/form')}}" style="color:#000000">Voltar</a></th>
            </tr>
        </table>
        ...
        <div class="card-body">
            ...
            <table class="table">
                ...
                <tbody>
                   ...
                   <a href="uc07/excel" class="btn" style="background-color: #6ab2ec;" target="_blank">Exportar Excel</a>
