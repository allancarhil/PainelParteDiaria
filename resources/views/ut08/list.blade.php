...
<div class="container">
    <div class="card-header" style="background-color: #6ab2ec">
        <table class="table table-borderless justify">
            <tr>
                <th scope="col">
                    <h1 style="font-weight: bold;">UT-08</h1>
                </th>
                <th scope="col" class="d-flex justify-content-end"><a class="btn btn-light" href="{{url('ut08/form')}}" style="color:#000000">Voltar</a></th>
            </tr>
        </table>
        ...
        <div class="card-body">
            ...
            <table class="table">
                <tbody style="font-size: 20px; font-weight:500;">
                   ...
                   <a href="ut08/excel" class="btn" style="background-color: #6ab2ec;" target="_blank">Exportar Excel</a>
